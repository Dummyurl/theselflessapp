...
/**
 * Created by ourdesignz on 21/10/16.
 */
...
public class CheckInCheckOutPOJO {
    ...
    @JsonProperty("data")
    private List<CheckInCheckOutPOJO.Datum> data = new ArrayList<CheckInCheckOutPOJO.Datum>();
    @JsonIgnore
     ...
     */
    @JsonProperty("data")
    public List<CheckInCheckOutPOJO.Datum> getData() {
        return data;
    }
     ...
     */
    @JsonProperty("data")
    public void setData(List<CheckInCheckOutPOJO.Datum> data) {
        this.data = data;
    }
