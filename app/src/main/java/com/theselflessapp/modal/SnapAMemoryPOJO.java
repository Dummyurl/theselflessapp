...
public class SnapAMemoryPOJO {
    ...
    @JsonProperty("data")
    private List<SnapAMemoryPOJO.Datum> data = new ArrayList<SnapAMemoryPOJO.Datum>();
    @JsonIgnore
     ...
     */
    @JsonProperty("data")
    public List<SnapAMemoryPOJO.Datum> getData() {
        return data;
    }
     ...
     */
    @JsonProperty("data")
    public void setData(List<SnapAMemoryPOJO.Datum> data) {
        this.data = data;
    }
